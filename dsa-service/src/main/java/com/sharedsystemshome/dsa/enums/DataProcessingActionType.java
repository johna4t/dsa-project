...
public enum DataProcessingActionType {
    ...
    CRAWLING("Scrapes data from websites or other digital sources."),
    ...
    PROFILING("Examines and analyses a data to understand its structure, content and quality."),
    PRODUCTION("Produces data from data inputs or existing data sources."),
    QUALITY_CONTROL("Ensures data accuracy, completeness, and consistency."),
    ...
    REVIEW("Checks data for correctness, completeness, and compliance."),
    ...
    SUBMISSION("Submits data to external regulatory bodies or authorities."),
    STREAMING("Transmits data in real-time or near-real-time."),
